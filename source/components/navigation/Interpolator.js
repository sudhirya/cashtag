...
function getForFade(): Function {
  return function (props: Object): Object {
    ...
    const opacity = position.interpolate({
      ...
      outputRange: ([0, 0, 1, 1, 1]: Array<number>),
    });
...
function getForSlideHorz(inverse: Boolean): Function {
  return function (props: Object): Object {
    const { layout, position, scene } = props;
...
const interpolators = {
  ...
  forFade: getForFade(),
  forSlideHorz: getForSlideHorz(false),
  forSlideHorzInverse: getForSlideHorz(true),
};
